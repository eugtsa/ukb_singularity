...
%post
  ...
  wget -c http://s3.amazonaws.com/plink2-assets/plink2_linux_avx2_20200310.zip
  mkdir /plink
  mv plink2_linux_avx2_20200310.zip /plink/plink2_linux_avx2_20200310.zip
  cd plink && unzip plink2_linux_avx2_20200310.zip && mv plink2 /usr/bin/plink2 && cd /
  ...
  #Install environment
   ...
   cd plink-ng/2.0/Python && python setup.py build_ext && pwd && pip install -e .
